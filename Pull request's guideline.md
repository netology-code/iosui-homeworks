...
* Добавьте в папку с проектом файл .gitignore (точка в названии обязательна) c кодом из репозитория по [этой ссылке](https://github.com/github/gitignore/blob/master/Swift.gitignore). [Видео-подсказка про создание .gitignore](https://github.com/netology-code/iosui-homeworks/tree/master/video/)
